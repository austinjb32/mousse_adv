...
def screenshot():
    ...
    img.save("C:\\Users\\austi\\OneDrive\\Documents\\Mousse_AI\\ss3.png")
...
def start_voice():
    ...
    while True:
        ...
        if "time" in query:
            ...
            speak("I'm JARVIS created by Unknown and I'm a desktop voice assistant.")
            print("I'm JARVIS created by Unknown and I'm a desktop voice assistant.")
